...
public class PanProgram {
    private PanSymbolTable varTable;
    ...
    public void generateTarget() {
        ...
        for (PanSymbol symbol : varTable.getAll()) {
    ...
    public PanSymbolTable getVarTable() {
        return varTable;
    }

    public void setVarTable(PanSymbolTable varTable) {
